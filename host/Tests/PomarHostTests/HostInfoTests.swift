...
@Test func shimWaitsThenExecsTheCommandInTheWorkDirectory() {
    ...
    #expect(args[2].contains("while [ ! -e /pomar/home/.pomar-ready ]"))
...
@Test func extractReleasesTheShimOnlyAfterUnpacking() {
    ...
    #expect(script.contains("tar -xf /pomar/source -C /work && rm -f /pomar/source && { getent passwd 1000 >/dev/null || echo 'pomar:x:1000:1000:pomar:/pomar/home:/bin/sh' >> /etc/passwd; } && { getent group 1000 >/dev/null || echo 'pomar:x:1000:' >> /etc/group; } && mkdir -p /pomar/home && chown -R 1000:1000 /work /pomar/home && touch /pomar/home/.pomar-ready"))
}
...
@Test func extractWaitsForTheProxyShimWhenAsked() {
    ...
    #expect(script.hasSuffix("touch /pomar/home/.pomar-ready"))
}
...
@Test func bundleSourceBecomesARepositoryWithNoRemote() {
    ...
    #expect(script.hasSuffix("rm -f /pomar/source && { getent passwd 1000 >/dev/null || echo 'pomar:x:1000:1000:pomar:/pomar/home:/bin/sh' >> /etc/passwd; } && { getent group 1000 >/dev/null || echo 'pomar:x:1000:' >> /etc/group; } && mkdir -p /pomar/home && chown -R 1000:1000 /work /pomar/home && touch /pomar/home/.pomar-ready"))
}
